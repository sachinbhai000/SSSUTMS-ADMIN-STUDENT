...
const RefoundCancellation = () => {
  ...
  `
      ...
      <Nav />
      <h3 style={{ fontFamily: 'cursive',marginLeft:'50px', fontWeight:700,color: '#1d3557',marginTop:'40px' }}> Refund & Cancellation </h3>
      ...
      <div className="privacy-page-body">
        <div className="privacy-content">
          ...
          <div className="privacy-paragraph-heading" style={{ fontFamily: 'inherit',textTransform:'uppercase' }}>Refund and Cancellation Policy</div>
