            ...
            <Table sx={{ minWidth: 50 }} aria-label="customized table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="center" style={{backgroundColor:"#e6ecf0",color:"black",fontWeight:"bold"}}>Password</StyledTableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                  ...
                  <StyledTableRow key={index}>
                    {user ? (
                      <>
                        ...
                        <StyledTableCell align="right">{user.randomPassword}</StyledTableCell>
