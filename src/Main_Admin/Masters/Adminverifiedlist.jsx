...
//   return (
//     <h1 style={{textAlign:"center"}}>Adminverifiedlist</h1>
//   )
// }
...
const Adminverifiedlist = () => {
  ...
  const fetchApprovedStudents = async () => {
    try {
      const response = await axios.get(`http://localhost:7786/apitest/admin/v1/epravesh/approve?branch=${branch1}`);
