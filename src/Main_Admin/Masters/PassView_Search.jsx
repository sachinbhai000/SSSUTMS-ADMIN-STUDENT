...
function PassView_Search() {
    ...
    const handleSearch = async () => {
        if (!selectedField || selectedField === "option1" || !enteredValue) {
            alert("Please select a valid search field and enter a value.");
            return;
        }

        try {
            const api = `https://sssutms.ac.in/apitest/admin/password-search?search=${enteredValue}&field=${selectedField}`;
                        ...
                        <Row>
                            <Col xs={12} sm={12} md={10} lg={9} xl={8} className="custom-laptop-style">
                                <div className="shadow-box">
                                    <div className="header">View Student Password</div>
                                            ...
                                            <Row>
                                                <FormControl>
                                                    ...
                                                    >
                                                        ...
                                                        <option value="randomId"> Random ID</option>
                                                    </Form.Select>
                                                </FormControl>
                                            </Row>
                                            <br></br>
...
export default PassView_Search;
