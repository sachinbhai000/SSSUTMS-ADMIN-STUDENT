...
import fop from '../../images/FOP.jpg'
import FOP1 from '../../images/FOP1.png'
...
<div style={{ position: 'relative', width: '100%' }}>
  <img src={fop} style={{ height: '350px', width: '100%' }} alt="Background" />
  <div style={{
    position: 'absolute', top: 0, left: 0, height: '350px', width: '30%',
    backgroundColor: '#003049'
  }}> <h1 style={{ position: 'absolute',  textAlign: 'left', color: 'white', padding: '20px' }}>FACULTY OF 
  <br></br>PHARMACY</h1>
  </div></div> 
    ...
    {activeTab === 'tab1' && (
      <>
        <div data-aos='fade-right' className='title aos-init aos-animate' style={{fontFamily:"'Open Sans', Sans-serif", marginTop: '40px', marginLeft: '50px' }}>
          <h4 style={{fontWeight:700,fontFamily:"'Open Sans', Sans-serif",color:'#264653'}}> INSTITUTE NAME: SCHOOL OF PHARMACY (4 Year)</h4>
        </div>
        <br></br>
        <div className="grid">
          <article>
            ...
            <img  className="custom-img"  src={medicine} alt="Medicine" />
              <h6 style={{ fontSize: '15px', marginTop: '9px', marginLeft: '10px' }}>Bachelor of Pharmacy</h6>
            </div>
          </article>
...
<div className="wrapper">
  ...
  <h1 style={{color:'white',marginLeft:'20px'}}>What makes
    <span style={{color:'orange'}}> SSSUTMS Faculty of Pharmacy unique?</span>
  </h1>
</div>
  ...
  <div className="box">
    ...
    The pharmaceutical industry is one of the fastest-growing sectors today. With medications playing a crucial role in universal healthcare, pharmacists hold vital positions within the medical field.
    </p>
  </div>
  <div className="box">
    <p className='vertical-line' style={{textAlign:'justify',marginTop:'5px',color:'white'}}>
    Pharmacy is a research-driven program, offering students extensive opportunities for growth and advancement. As a continuously evolving field, it consistently introduces new developments and dimensions.
    </p>
  </div>
  <div className="box">
    <p className='vertical-line' style={{textAlign:'justify',marginTop:'5px',color:'white'}}>
  ...
  <div className="box">
    <p  className='vertical-line'style={{textAlign:'justify',marginTop:'5px',color:'white'}}>
    Using of modern teaching methods and tools to make learning easier for students. To impart communication, teamwork, responsibility and leadership among our graduates.
    </p>
  </div>
</section></div>
...
<div  className='headinghai'>
  ...
  <h1>About
    ...
    <section className="info" style={{marginTop:'-20px'}} >
      ...
      <img  className='imgabout'src={FOP1} alt="" />
      <div>
     
        {/* <h2 style={{ fontFamily:"'Open Sans', Sans-serif",color:'#023047'}}>About */}
        {/* Faculty of Engineering & Technology</h2> */}
        <p style={{textAlign:'justify'}}>
        The Faculty of Pharmacy is dedicated to advancing pharmaceutical education, research, and practice. Our programs are designed to provide students with a comprehensive understanding of the pharmaceutical sciences, integrating both theoretical knowledge and practical skills.

Our esteemed faculty members are leaders in their fields, bringing a wealth of experience and expertise to the classroom. They are committed to fostering a dynamic learning environment that encourages innovation and critical thinking.

We offer a range of undergraduate and postgraduate programs that cater to the diverse interests and career aspirations of our students. Our curriculum is continually updated to reflect the latest advancements in pharmaceutical research and healthcare practices.

Students benefit from state-of-the-art laboratories, research facilities, and collaborations with leading industry professionals. These resources ensure that graduates are well-prepared to meet the demands of the rapidly evolving pharmaceutical industry.

At the Faculty of Pharmacy, we are dedicated to shaping the future of healthcare by educating the next generation of pharmacists and researchers who will contribute to the well-being of communities worldwide.
