...
function Entrance_Payment() {
 ...
 console.log(courseType , courseName , id ,"data")
  ...
  const fetchFeeInformation = () => {
    ...
    const apiUrl = process.env.REACT_APP_ENTRANCE_PAYMENT + `${sessionYear}&courseName=${courseName}`;
  ...
  const getData = (data) => {
    setLoading(false);
    return fetch(process.env.REACT_APP_ENT_PAYMENT, {
      method: "POST",
      headers: {
