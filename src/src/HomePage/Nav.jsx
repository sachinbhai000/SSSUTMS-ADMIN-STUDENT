 ...
 font-weight:bold;
  ...
  @import url('https://fonts.googleapis.com/css2?family=Basic&family=Doppio+One&display=swap')
    ...
    `}</style>
      ...
      <nav className="navbar navbar-expand-md bg-body-tertiary sticky-top" style={{ width: '100%' }}>
        <div className="container-xl" style={{ width: '100%' }}>
          <a className="navbar-brand" href="#">
            <Link to='/'><img style={{ marginLeft: '-5px' }} src={logo} /></Link>
          </a>
          <button
          ...
          >
            <div className="contact-info d-md-flex">
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                >
                  ...
                  <h1 style={{ fontSize: '12px', textTransform: 'uppercase', fontFamily: 'Montserrat', fontWeight: '700' }}><a
                    className="nav-link dropdown-toggle"
                    href="#"
                    style={{ textTransform: 'upperCase', fontFamily: 'montserrat', color: "#dd2d4a", fontWeight: 'bold', fontSize: "13px" }}
                  > Academic  </a></h1>

                  <div className={`dropdown-menu ${isOpen ? "show" : ""}`}>
                    <a className="dropdown-item" href="/academic-calender" target="_blank" style={{ marginTop: '-10px' }}>
                      {" "}
                      <p className="pstyle">Academic Calendar</p>
                    </a>
                    <a className="dropdown-item"
                      href="#">
                      <p className="pstyle">Study Materials</p>
                    </a>
                    <a className="dropdown-item" href="#">
                      <p className="pstyle">Scholarship</p>

                    </a>
                    <a className="dropdown-item " href={COA} target="_blank">
                      <p className="pstyle">COA Approvals</p>
                    </a>
                  </div>
                </li>
                ...
                >
                  ...
                  <h1 style={{ fontSize: '12px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: '700' }}>   <a
                    className="nav-link dropdown-toggle"
                    href="#"
                    style={{ color: "#dd2d4a", fontSize: "13px" }}
                  >School & Department</a></h1>
                  ...
                  >
                    ...
                    <a className="dropdown-item" href="#" style={{ marginTop: '-10px' }}>
                      <p className="pstyle">School Of Law  </p>
                    </a>   <a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Design  </p>
                    </a>   <a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Nursing  </p>
                    </a>
                    <a className="dropdown-item" href="/pharma">
                      <p className="pstyle">School Of Pharmacy  </p>
                    </a>   <a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Agriculture  </p>
                    </a>     <a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Commerce  </p>
                    </a><a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Paramedical  </p>
                    </a>
                    <a className="dropdown-item" href="#">
                      <p className="pstyle">School Of Management  </p>
                    </a>
                ...
                >
                  ...
                  >
                    <div style={{ marginLeft: "25px" }}>
                      ...
                      <a className="dropdown-item" href="#" >
                        <h1 style={{ fontSize: '13px', color: '#d00000', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: '700' }}>
            ...
            <a
              ...
              aria-expanded="false"
              style={{ color:"red", fontSize: '12px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: '700' }}
           ...
           <b>Download </b>  
              ...
              <li
                ...
                >
                  ...
                  <div className={`dropdown-menu ${isOpen14 ? "show" : ""}`} style={{marginLeft:"100%",marginTop:"-30px"}} >
                    ...
                    >
                      {" "}
                      <p className="pstyle">PH.D Degree Awarded during 2016-2020  </p>
                    </a>
                ...
                >
                  ...
                  <div className={`dropdown-menu ${isOpen12 ? "show" : ""}`}>
                    ...
                    >
                      {" "}
                      <p className="pstyle">Engineering  </p>
                    </a>
                    ...
                    >
                      <p className="pstyle">Agriculture  </p>
                    </a>
                ...
                <Link to="/entrance/form">
                  <li className="nav-item">
                    ...
                    >
                      <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bolder' }}>Entrance Exam</h1>
                    </a>
                    <style>
                      {`
                              @keyframes blink {
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              <Link to="/">
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="#">
                    <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}>Home</h1>
                  </a>
                </li>
              </Link>
              ...
              >
                ...
                <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}>
              ...
              >
                ...
                <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}>  <a className="nav-link dropdown-toggle" href="#">Examination</a></h1>

                <div className={`dropdown-menu ${isOpen9 ? "show" : ""}`}>
                  <a className="dropdown-item " href="#" style={{ marginTop: '-8px' }}>
                    <p className="pstyle"> Results </p>
                  </a>
                  <a className="dropdown-item " href="#">
                    <p className="pstyle"> Apply for Exam</p>
                  </a>
                  <a className="dropdown-item " href="/exam-schedule">
                    <p className="pstyle"> Exam Schedule</p>
                  </a>
                  <a className="dropdown-item " href="/exam-notifications">
                    {" "}
                    <p className="pstyle"> Exam Notification</p>
                  </a>

                  <a className="dropdown-item " href="#">
                    {" "}
                    <p className="pstyle"> Apply for Certificates</p>
                  </a>
                </div>
              </li>
              ...
              >
                ...
                <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}> <a className="nav-link dropdown-toggle" href="#">Research</a></h1>

                <div className={`dropdown-menu ${isOpen10 ? "show" : ""}`}>
                  <a className="dropdown-item " href="/resarch-promotion-policy" style={{ marginTop: '-8px' }}>
                    <p className="pstyle"> Research & Promotion Policy</p>
                  </a>
                  <a className="dropdown-item " href="/doctoral-phd">
                    <p className="pstyle"> Doctoral Programs PhD</p>
                  </a>
                  <a className="dropdown-item " href={excell} target="_blank">
                    <p className="pstyle">  Centre Of Excellence</p>
                  </a>
                  <a className="dropdown-item " href="/consultancy-services">
                    <p className="pstyle"> Consultancy Services{" "}</p>
                  </a>
                  <a className="dropdown-item " href="/mou-collaboration">
                    <p className="pstyle">  MOU & Collaboration</p>
                  </a>
                  <a className="dropdown-item " href="#">
                    <p className="pstyle"> Centre For Development Of Entreprenurship</p>
                  </a>
              ...
              <li className="nav-item">
                <a className="nav-link" href="/placement">
                  <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}>Placement</h1>
                </a>
              </li>
              <Link to="/contact">
                <li className="nav-item">
                  <a className="nav-link">
                    <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}>Contact </h1>
                  </a>
                </li>
              </Link>
              <li className="nav-item">
                <a className="nav-link"
                href="/campus">
                  <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bold' }}> Campus</h1>
                </a>
              </li>
              <Link to="/Epravesh/Student/Register">
                <li className="nav-item">
                  ...
                  >
                    <h1 style={{ fontSize: '13px', fontFamily: 'Montserrat', textTransform: 'uppercase', fontWeight: 'bolder' }}> E-Pravesh </h1>
                  </a>
                </li>
              </Link>
